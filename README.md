...
<div align=center><img src="http://chart.googleapis.com/chart?cht=tx&chl=\sqrt{a+a} z = \mu + \sigma \odot \epsilon" style="border:none;"></div>
...
<div align=center><img src="http://chart.googleapis.com/chart?cht=tx&chl=-KL \left \( q(z|x)||P(z)\right )" style="border:none;"></div>
